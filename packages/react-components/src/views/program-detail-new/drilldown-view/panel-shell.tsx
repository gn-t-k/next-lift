...
export const DrilldownPanelShell: FC<Props> = ({
	title,
	meta,
	leading,
	actions,
...
export const DrilldownPanelShellLoading: FC = () => (
	<PanelShell
		title={
...
type DrilldownPanelShellErrorProps = {
	message?: ReactNode;
};

export const DrilldownPanelShellError: FC<DrilldownPanelShellErrorProps> = ({
	message,
}) => {
